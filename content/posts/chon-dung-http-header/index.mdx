...
1) Server trả về file test.js, kèm theo Header **ETag** có nội dung *x234dff* . 
2) Browser tải file test.js về và sử dụng.

![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/mxohnjsajo_etag1.png)
*image from Google Web Fundamental series*

3) Browser muốn tải lại test.js ở 1 màn hình khác, phát hiện bản test.js được cache đã hết hạn (bằng cách đọc **Cache-Control** của file, sẽ giải thích ở dưới).
4) Browser tải file từ example.com/test.js và gửi kèm Header **If-None-Match** với nội dung *x234dff* .
...
![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/ciwr2atsvi_etag2.png)
*image from Google Web Fundamental series*
...
![alt text](https://s3-ap-southeast-1.amazonaws.com/kipalog.com/blg71r4q6p_http-cache-decision-tree.png)
*image from Google Web Fundamental series*
